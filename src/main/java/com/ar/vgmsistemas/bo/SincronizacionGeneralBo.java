...
//import com.ar.vgmsistemas.dao.IArticulosListaDao;
////import com.ar.vgmsistemas.configuracion.Configuracion;
//import com.ar.vgmsistemas.dao.IBancoDao;
//import com.ar.vgmsistemas.dao.ICategoriaFiscalDao;
//import com.ar.vgmsistemas.dao.IChequeDao;
//import com.ar.vgmsistemas.dao.ICondicionVentaDao;
//import com.ar.vgmsistemas.dao.ICuentaCorrienteDao;
//import com.ar.vgmsistemas.dao.IDepositoDao;
//import com.ar.vgmsistemas.dao.IDocumentoDao;
//import com.ar.vgmsistemas.dao.IEmpresaDao;
//import com.ar.vgmsistemas.dao.IEntregaCobranzaDao;
//import com.ar.vgmsistemas.dao.IImpuestoDao;
//import com.ar.vgmsistemas.dao.IListaPrecioDao;
//import com.ar.vgmsistemas.dao.IListaPrecioDetalleDao;
//import com.ar.vgmsistemas.dao.ILocalidadDao;
//import com.ar.vgmsistemas.dao.IMotivoAutorizacionDao;
//import com.ar.vgmsistemas.dao.IMotivoNoPedidoDao;
//import com.ar.vgmsistemas.dao.IPlanCuentaDao;
//import com.ar.vgmsistemas.dao.IProveedorDao;
//import com.ar.vgmsistemas.dao.IProvinciaDao;
//import com.ar.vgmsistemas.dao.IReciboDao;
//import com.ar.vgmsistemas.dao.IReciboDetalleDao;
//import com.ar.vgmsistemas.dao.IRecursoHumanoDao;
//import com.ar.vgmsistemas.dao.IRepartidorDao;
//import com.ar.vgmsistemas.dao.IRetencionDao;
////import com.ar.vgmsistemas.dao.IRetencionDao;
//import com.ar.vgmsistemas.dao.ITipoMonedaDao;
//import com.ar.vgmsistemas.dao.IVendedorDao;
import com.ar.vgmsistemas.dao.filesystem.ManageFilesDao;
//import com.ar.vgmsistemas.dto.Banco;
//import com.ar.vgmsistemas.dto.CategoriaFiscal;
//import com.ar.vgmsistemas.dto.Cheque;
//import com.ar.vgmsistemas.dto.Cliente;
//import com.ar.vgmsistemas.dto.CondicionVenta;
//import com.ar.vgmsistemas.dto.CuentaCorriente;
//import com.ar.vgmsistemas.dto.Deposito;
//import com.ar.vgmsistemas.dto.Documento;
//import com.ar.vgmsistemas.dto.Empresa;
//import com.ar.vgmsistemas.dto.EntregaCobranza;
//import com.ar.vgmsistemas.dto.Impuesto;
//import com.ar.vgmsistemas.dto.ListaPrecio;
//import com.ar.vgmsistemas.dto.ListaPrecioDetalle;
//import com.ar.vgmsistemas.dto.MotivoAutorizacion;
//import com.ar.vgmsistemas.dto.MotivoNoPedido;
//import com.ar.vgmsistemas.dto.PlanCuenta;
//import com.ar.vgmsistemas.dto.Proveedor;
//import com.ar.vgmsistemas.dto.Recibo;
//import com.ar.vgmsistemas.dto.ReciboDetalle;
//import com.ar.vgmsistemas.dto.RecursoHumano;
//import com.ar.vgmsistemas.dto.Repartidor;
//import com.ar.vgmsistemas.dto.Retencion;
////import com.ar.vgmsistemas.dto.Retencion;
//import com.ar.vgmsistemas.dto.TipoMoneda;
//import com.ar.vgmsistemas.dto.Vendedor;
import com.ar.vgmsistemas.utils.CodeResult;

@Component
public class SincronizacionGeneralBo {
	@Autowired
...
//	@Autowired
//	private ICategoriaFiscalDao categoriaFiscalDao;
//	@Autowired
//	private IChequeDao chequeDao;
//	@Autowired
//	private ICuentaCorrienteDao cuentaCorrienteDao;
//	@Autowired
//	private IMotivoAutorizacionDao motivoAutorizacionDao;
//	@Autowired
...
//	@Autowired
//	private IEntregaCobranzaDao entregaCobranzaDao;
//	@Autowired
//	private IListaPrecioDao listaPrecioDao;
//	@Autowired
//	private IListaPrecioDetalleDao listaPrecioDetalleDao;
//	@Autowired
//	private ILocalidadDao localidadDao;
//	@Autowired
//	private IMotivoNoPedidoDao motivoNoPedidoDao;
//	@Autowired
...
//	@Autowired
//	private IRecursoHumanoDao recursoHumanoDao;
//	@Autowired
//	private IReciboDao reciboDao;
//	@Autowired
//	private IReciboDetalleDao reciboDetalleDao;
//	@Autowired
//	private IRepartidorDao repartidorDao;
//	@Autowired
//	private IRetencionDao retencionDao;
//	@Autowired
...
//	public static List<Documento> documentos;
	...
	public String iniciarSincronizacion(Integer idVendedor, Session metadata, String bd, SqliteConnectionConfig config) throws Exception {		
			...
			// Condicion Venta*/
			//List<CondicionVenta> condicionesVentas = condicionVentaDao.recoveryAll();
			// Condicion Iva
...
*/
			// Lista de Precios
			//List<ListaPrecio> listasPrecios = listaPrecioDao.recoveryAll();
...
/*			List<PlanCuenta> planesCuentas = planCuentaDao.recoveryAll();
			...
			*/
			...
			// Condicion Venta
			//condicionVentaDao.createForLote(condicionesVentas, metadata);
			// Condicion Iva
			...
			// Lista de Precios
			//listaPrecioDao.createForLote(listasPrecios, metadata);
/*			// Lista de precios
